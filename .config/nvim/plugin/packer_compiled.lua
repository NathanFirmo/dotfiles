...
_G.packer_plugins = {
  ...
  ["copilot-cmp"] = {
    ...
    loaded = false,
    needs_bufread = false,
    path = "/home/nathan/.local/share/nvim/site/pack/packer/opt/copilot-cmp",
    url = "https://github.com/zbirenbaum/copilot-cmp"
  },
  ["copilot.lua"] = {
    after = { "copilot-cmp" },
    commands = { "Copilot" },
    config = { "\27LJ\2\n.\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\19copilot-config\frequire\0" },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
    path = "/home/nathan/.local/share/nvim/site/pack/packer/opt/copilot.lua",
