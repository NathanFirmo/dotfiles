...
alias serve-payments="~/scripts/shell/V3_db_up.sh && nx run-many --target=serve --projects=ui-payments,api-accounts,api-organizations,api-permissions,api-storage,api-payments --parallel --maxParallel=100 --inspect=false -c ssl"
